config_dict = {
    ...
    "connector-shape-edge-length": 180,
    "connector-shape-left-pixel-density": 1563,
    "connector-shape-right-pixel-density": 1399,
    "allowed-connector-shape-left-offset": 210,
    "allowed-connector-shape-right-offset": 95
}